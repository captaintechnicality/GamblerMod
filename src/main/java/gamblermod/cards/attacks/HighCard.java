...
public class HighCard extends CustomCard {
    public static final String ID = "gamblermod:HighCard";
    ...
    public HighCard(int Value)
    {
        super( ID , NAME, IMG_PATH, COST, DESCRIPTION,
                CardType.ATTACK, AbstractCardEnum.Gambler_CHECKERBOARD,
                CardRarity.SPECIAL, CardTarget.ENEMY);
        CardValue = Value;
        this.baseDamage = CardValue;
        this.exhaust = true;
    }
